        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div class="mt-2"><label for="make" class="block text-sm font-medium text-gray-700">Make</label>
...
export default {
  ...
  methods: {
    ...
    submit() {
      this.createModel({name:this.name, make: this.make}).then(() => {
        ...
        this.setNotification({
          message: 'There was a problem creating this Models.',
          class: 'bg-red-600'
        });
      }).finally(()=> {
